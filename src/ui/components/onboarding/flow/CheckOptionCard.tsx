 ...
 * variants cannot drift apart on radius, focus ring or transition.
 */
...
export function CheckOptionCardGroup({
  ...
  return (
    <fieldset className={cn("m-0 w-full min-w-0 border-0 p-0", className)}>
      ...
      <div className="mx-auto grid w-full max-w-[47.375rem] grid-cols-1 gap-2 sm:grid-cols-2">
        {choices.map((choice) => {
          ...
          return (
            <label
              ...
              className={cn(
                ...
                "min-h-[3.625rem] gap-2 py-3 pr-4 pl-3",
              )}
            >
              <input
                type="checkbox"
