      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {canAddMore && (
          <div
            ...
            className={cn(
              "flex h-22 w-22 shrink-0 cursor-pointer flex-col items-center justify-center gap-1 rounded-xl border-2 border-dashed border-border bg-card text-muted-foreground transition-colors hover:border-primary/50 hover:bg-muted/50 hover:text-foreground",
